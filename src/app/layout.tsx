...
export const metadata: Metadata = {
  ...
  description:
    "Open-source AI platform for creating, optimizing, and scaling your content strategy. Generate SEO-optimized blog posts in seconds with advanced AI algorithms.",
  ...
  openGraph: {
    ...
    description:
      "Open-source AI platform for creating, optimizing, and scaling your content strategy. Generate SEO-optimized blog posts in seconds.",
    images: [
      {
